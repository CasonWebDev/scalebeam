            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Solicitação de Template · {project.brand.name} · {project.brand.organization.name}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">
                    Analisar o material enviado e especificações
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">
                    Desenvolver o template baseado nas necessidades
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">
                    Altere o status do template para "Aprovado" quando estiver pronto
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-medium">Pronto para Uso</p>
                  <p className="text-muted-foreground text-xs">
                    Cliente poderá criar campanhas usando este template
                  </p>
                </div>
              </div>
            </div>
